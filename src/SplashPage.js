  ...
  return (
    <Container className="container" fluid>
      <Row>
        ...
        <h7 className="d-block describe"><strong>Search</strong> for user and topic tweets user or view a <strong>random</strong> tweet from one of my five favorite twitter users.</h7>
